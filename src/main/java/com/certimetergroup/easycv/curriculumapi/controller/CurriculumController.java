...
public class CurriculumController {
    ...
    public ResponseEntity<Response<PagedModel<CurriculumLightDto>>> getCurriculums(
        ...
        return ResponseEntity.ok().body(new Response<>(ResponseEnum.SUCCESS, curriculumService.getCurriculums(page, pageSize, userIds)));
    }
    ...
    public ResponseEntity<Response<Void>> deleteCurriculum(
            @PathVariable @NotNull(message = "Curriculum Id required") @Positive(message = "Wrong curriculum id provided") Long id) {
